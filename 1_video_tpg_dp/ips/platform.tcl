...
if {$EXTENSIBLE_PLATFORM} {
    ...
    set_property PFM.CLOCK {clk_100M {id "0" is_default "true" proc_sys_reset "/ps_reset_100M" status "fixed" freq_hz "$(99999000)"}} [get_bd_cells /clk_wiz_0]
